namespace FilmsManage.GUI.UserControls.Data
{
    partial class PhimUC
    {
		...
		private void InitializeComponent()
		{
			...
			lwShow.Location = new Point(2, 840);
			...
			lblMovieID.Location = new Point(91, 370);
			...
			ccbDangPhim.Location = new Point(832, 762);
			...
			lblMovieName.Location = new Point(91, 430);
			...
			// txtMovieName
			// 
			txtMovieName.Location = new Point(261, 433);
			...
			lblMovieDesc.Location = new Point(91, 486);
			...
			lblMovieProductor.Location = new Point(661, 644);
			...
			lblMovieDirector.Location = new Point(661, 704);
			...
			lblMovieGenre.Location = new Point(56, 596);
			...
			lblMovieYear.Location = new Point(661, 763);
			...
			// txtMovieDesc
			// 
			txtMovieDesc.Location = new Point(261, 486);
			...
			lblMovieLength.Location = new Point(662, 474);
			...
			lblMovieStartDate.Location = new Point(662, 530);
			...
			lblMovieEndDate.Location = new Point(662, 586);
			...
			// txtMovieLength
			// 
			txtMovieLength.Location = new Point(832, 477);
			...
			// txtDoTuoi
			// 
			txtDoTuoi.Location = new Point(831, 652);
			...
			// txtMovieDirector
			// 
			txtMovieDirector.Location = new Point(831, 710);
			...
			dtmMovieStart.Location = new Point(832, 530);
			...
			dtmMovieEnd.Location = new Point(832, 586);
			...
			picFilm.Location = new Point(1215, 374);
			...
			// txtMovieID
			// 
			txtMovieID.Location = new Point(261, 378);
			...
			pnlLoaiPhim.Location = new Point(185, 599);
			...
			label1.Location = new Point(662, 374);
			...
			// txtGhiChu
			// 
			txtGhiChu.Location = new Point(832, 377);
			...
			label2.Location = new Point(662, 424);
			...
			// txtNoiDung
			// 
			txtNoiDung.Location = new Point(832, 427);
			...
			btnAddMovie.Font = new Font("Segoe UI", 9F);
			...
			btnAddMovie.OnIdleState.BorderColor = Color.DodgerBlue;
			btnAddMovie.OnIdleState.BorderRadius = 1;
			btnAddMovie.OnIdleState.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton.BorderStyles.Solid;
			btnAddMovie.OnIdleState.BorderThickness = 1;
			btnAddMovie.OnIdleState.FillColor = Color.DodgerBlue;
			...
			btnAddMovie.OnPressedState.BorderColor = Color.FromArgb(40, 96, 144);
			btnAddMovie.OnPressedState.BorderRadius = 1;
			btnAddMovie.OnPressedState.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton.BorderStyles.Solid;
			btnAddMovie.OnPressedState.BorderThickness = 1;
			btnAddMovie.OnPressedState.FillColor = Color.FromArgb(40, 96, 144);
			...
			btnAddMovie.Size = new Size(211, 62);
			...
			btnUpdateMovie.Font = new Font("Segoe UI", 9F);
			...
			btnUpdateMovie.OnIdleState.BorderRadius = 1;
			btnUpdateMovie.OnIdleState.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton.BorderStyles.Solid;
			btnUpdateMovie.OnIdleState.BorderThickness = 1;
			btnUpdateMovie.OnIdleState.FillColor = Color.DodgerBlue;
			...
			btnUpdateMovie.OnPressedState.BorderColor = Color.FromArgb(40, 96, 144);
			btnUpdateMovie.OnPressedState.BorderRadius = 1;
			btnUpdateMovie.OnPressedState.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton.BorderStyles.Solid;
			btnUpdateMovie.OnPressedState.BorderThickness = 1;
			btnUpdateMovie.OnPressedState.FillColor = Color.FromArgb(40, 96, 144);
			...
			btnUpdateMovie.Size = new Size(211, 62);
			...
			btnUpdateMovie.Click += btnUpdate_Click;
			// 
			// btnDeleteMovie
			// 
			...
			btnDeleteMovie.Font = new Font("Segoe UI", 9F);
			...
			btnDeleteMovie.OnIdleState.BorderRadius = 1;
			btnDeleteMovie.OnIdleState.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton.BorderStyles.Solid;
			btnDeleteMovie.OnIdleState.BorderThickness = 1;
			btnDeleteMovie.OnIdleState.FillColor = Color.DodgerBlue;
			...
			btnDeleteMovie.OnPressedState.BorderColor = Color.FromArgb(40, 96, 144);
			btnDeleteMovie.OnPressedState.BorderRadius = 1;
			btnDeleteMovie.OnPressedState.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton.BorderStyles.Solid;
			btnDeleteMovie.OnPressedState.BorderThickness = 1;
			btnDeleteMovie.OnPressedState.FillColor = Color.FromArgb(40, 96, 144);
			...
			btnDeleteMovie.Size = new Size(211, 62);
			...
			btnExport.Location = new Point(875, 199);
			...
			btnExport.Size = new Size(211, 62);
